...
*/
 ...
 array( 'validate' => 'posticode', 'format' => 'posticode', 'name'=>'billing-postciode', 'label' => __('Posticode', 'jigoshop'), 'placeholder' => __('Posticode', 'jigoshop'), 'required' => true, 'class' => array('form-row-first') ),
...
{
	$ImageUrl = WL_TEMPLATE_DIR_URI ."/images/portfolio1.png";
