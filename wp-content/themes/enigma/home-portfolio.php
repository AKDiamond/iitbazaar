						...
						<div class="enigma_home_portfolio_showcase">
							...
							<div class="enigma_home_portfolio_showcase_overlay">
								<div class="enigma_home_portfolio_showcase_overlay_inner ">
										...
										<a title="<?php the_title_attribute(); ?>" href="<?php echo esc_url($wl_theme_options['port_'.$i.'_link']); ?>"></a>
										<a class="photobox_a" href="<?php echo esc_url($wl_theme_options['port_'.$i.'_img']); ?>"><img src="<?php echo esc_url($wl_theme_options['port_'.$i.'_img']); ?>" alt="<?php echo esc_attr($wl_theme_options['port_'.$i.'_title']); ?>" style="display:none !important;visibility:hidden"></a>
