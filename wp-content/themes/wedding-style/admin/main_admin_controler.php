<?php 
$wedding_style_theme_name='Wedding Style Options'; /// menu theme name

$wedding_style_special_id_for_db='news_magazine'; // spec identifikator databese

$wedding_style_show_logo=true; /// if set tru show web dorado logo in admin panel if false dont show
...
function wedding_style_web_dor_theme_control_pages(){
	...
	global  $wedding_style_layout_page,// layout page class
			$wedding_style_general_settings_page,// general page class
			$wedding_style_home_page,// home page class
			$wedding_style_integration_page,// integration page class
			$wedding_style_color_control_page,// color page class
			$wedding_style_typography_page,// typography page class
			$wedding_style_slider_page,// slider page class
			$wedding_style_sample_date,// sample_date page class
			$wedding_style_licensing_page;
	...
	<?php global $wedding_style_show_logo; if($wedding_style_show_logo){?><div style="background-image:url(<?php echo get_template_directory_uri(); ?>/images/adminheader.png);background-repeat: no-repeat; width: 90%;margin-left: 59px; height: 90px;"></div><?php }?>
	...
	<div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
				<div id="options-group-1" class="group Layout" style="display: none;"><h3>Layout Editor</h3><?php echo $wedding_style_layout_page->dorado_theme_admin_layout(); ?></div>
				<div id="options-group-2" class="group General" style="display: none;"><h3>General</h3><?php echo $wedding_style_general_settings_page->dorado_theme_admin_general_settings(); ?></div>
				<div id="options-group-3" class="group Homepage" style="display: none;"><h3>Homepage</h3><?php echo $wedding_style_home_page->dorado_theme_admin_home(); ?></div>
