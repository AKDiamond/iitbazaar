...
<div class="grid_16 content_wrap alpha">
    ...
    <div class="content">
        ...
        <h1>
            <?php if (is_day()) : ?>
                <?php printf(__('Daily Archives: %s', 'gommero'), get_the_date()); ?>
            <?php elseif (is_month()) : ?>
                <?php printf(__('Monthly Archives: %s', 'gommero'), get_the_date('F Y')); ?>
            <?php elseif (is_year()) : ?>
                <?php printf(__('Yearly Archives: %s', 'gommero'), get_the_date('Y')); ?>
            <?php else : ?>
                <?php _e('Blog Archives', 'gommero'); ?>
            <?php endif; ?>
        </h1>
        <?php
